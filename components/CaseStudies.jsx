  ...
  return (
    <section className="sec" id="cases">
      <div className="wrap-wide">
        ...
        <h2 className="sec__title">Two brands operationalized salience.</h2>
        <p className="sec__lede">From a 1928 visual mnemonic to 160 years of heritage codified into Brand Codes — both teams turned cue consistency into a measurable performance lever.</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 80, marginTop: 64 }}>
          ...
          <div key={c.brand} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            {c.quote &&
            <figure className="case-pullquote" style={{ margin: '36px auto 0', padding: '0 8px', maxWidth: 760, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                ...
                <p style={{ margin: 0, fontFamily: 'var(--cx-font-serif)', fontStyle: 'italic', fontWeight: 400, fontSize: 'clamp(22px, 2.2vw, 30px)', lineHeight: 1.35, letterSpacing: '-0.005em', color: 'var(--cx-fg-deep)', maxWidth: '46ch', textWrap: 'pretty' }}>
                  {c.quote}
                </p>
                <figcaption style={{ marginTop: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
