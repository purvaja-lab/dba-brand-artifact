  ...
  return (
    <section className="sec" id="dbas">
      <div className="wrap-wide">
        ...
        <h2 className="sec__title" style={{ fontSize: "62px", textAlign: "left" }}>What's a <em style={{ fontSize: "62px" }}>distinctive brand asset (DBA)?</em></h2>
        <p className="sec__lede" style={{ fontFamily: "\"Greed Standard\"", lineHeight: "1.2" }}>DBAs are the brand cues consumers use to recognize you in the 1-2 seconds your ad gets in-feed. Our research tracks seven brand cue categories across 1.4M ads. Hover any one to see how it shows up.
