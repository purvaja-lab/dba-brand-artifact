    ...
    <section className="sec" id="dbas">
      <div className="wrap-wide">
        ...
        <p className="sec__lede" style={{ fontFamily: "\"Greed Standard\"" }}>
          DBAs are the cues consumers use to recognize you in the 1–2 seconds your ad gets in-feed. The report tracks seven categories across 1.4M ads. Hover any one to see how it shows up.
        </p>
