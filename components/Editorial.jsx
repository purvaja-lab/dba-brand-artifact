      ...
      <div className="wrap-wide">
        <div className="grid-2" style={{ alignItems: 'end', marginBottom: 56, textAlign: "left" }}>
          ...
          <p className="sec__lede" style={{ fontFamily: "\"Greed Standard\"", fontWeight: "300", lineHeight: "1" }}>
            We analyzed 1.4 million ads — $2Bn of investment across 176 brands and 105+ markets — and found a consistent pattern: the brands winning recall are doing the same boring thing on every asset. The rest are not.
          </p>
        </div>
...
function ThreeFailures() {
  ...
  { n: '02', name: 'The Multiplier Effect (missed)', body: 'Cues are deployed in isolation. The 86% recall lift from pairing logo with packshot never compounds.' },
  { n: '03', name: 'The Loaned Brand', body: 'You pay for the reach, the creator carries the equity. 45% of creator spend on Meta leaves no brand fingerprint at all.' }];
        ...
        <div className="grid-2" style={{ alignItems: 'center' }}>
          <div>
            ...
            <h2 className="sec__title sec__title--sans" style={{ color: 'var(--cx-paper)', margin: '20px 0 0', fontSize: "44px", lineHeight: "0.8", letterSpacing: "-1px" }}>
              Built on $2Bn of real-world advertising data.
            </h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24 }}>
            {[
            ['1.4M', 'paid ads analyzed'],
            ['$2Bn', 'in ad spend analyzed'],
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 80, alignItems: 'start' }} className="closing-grid">
          <div>
            ...
            <p className="sec__lede" style={{ color: 'rgba(255,255,255,.78)', maxWidth: '48ch', fontFamily: "\"Greed Standard\"", lineHeight: "1.3" }}>
              <strong style={{ color: 'var(--cx-paper)' }}>Creative Salience</strong> by CreativeX is the platform leading brands use to audit, score, and enforce brand cues on every piece of creative — before a dollar of media ships.
            </p>
          ...
          <div style={{ border: '1px solid rgba(255,255,255,.14)', borderRadius: 24, padding: 36, background: "rgb(244, 243, 236)" }}>
            ...
            <div style={{ marginTop: 16, fontSize: 12, textAlign: 'center', color: "rgb(0, 60, 79)" }}>
              Based on analysis of 176 brands across 105+ markets.
            </div>
          </div>
        </div>
      </div>
