  ...
  return (
    <section className="hero" style={{ textAlign: 'center' }}>
      <div className="wrap-wide" style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <span className="hero__eyebrow">CREATIVE SALIENCE AND DISTINCTIVE BRAND ASSETS
        ...
        <p className="hero__sub" style={{ fontFamily: "\"Greed Standard\"" }}>A CreativeX study of $2B in advertising reveals how Distinctive Brand Assets (DBAs) drive Brand Recall and Increase Media Effectiveness.
        ...
        <div className="hero__meta">
          <div className="hero__meta-item">
            <span className="hero__meta-label">SAMPLE SIZE</span>
