    ...
    <section className="hero" style={{ textAlign: 'center' }}>
      ...
      <div className="wrap-wide" style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <p className="hero__sub" style={{ fontFamily: "\"Greed Standard\"" }}>
          A study of $2Bn in advertising reveals how marketers are quietly handing
          brand equity to platforms, creators, and GenAI — and the operational
          playbook to take it back.
        </p>
...
function Ticker() {
  const items = [
  { num: '$52Bn', label: 'in advertising efficiency at stake' },
  { num: '61%', label: 'of paid ads lack sufficient brand cues' },
  { num: '+28%', label: 'higher ad recall with 4+ brand cues' },
