      ...
      <div className="wrap-wide">
        <div className="grid-2" style={{ alignItems: 'end' }}>
          <div>
            ...
            <h2 className="sec__title" style={{ fontSize: "62px", lineHeight: "0.85" }}>When creators do the talking, your brand goes silent.</h2>
          </div>
          <p className="sec__lede" style={{ fontFamily: "\"Greed Standard\"", fontWeight: "300", lineHeight: "1.1" }}>
            Creator content drives reach — and drops cue density. Logos appear in creator ads roughly <strong>half</strong> as often as in brand-led content; taglines, less than half. The reach is real — the brand attribution often isn't.
          </p>
        </div>
        ...
        <div style={{ marginTop: 72, background: 'var(--cx-paper)', borderRadius: 28, border: '1px solid var(--cx-line)', overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 0 }} className="lb-grid">
            ...
            <div style={{ padding: 40, background: 'var(--cx-ocean)', color: 'var(--cx-paper)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'rgba(255,255,255,.55)' }}>The waste</div>
                <div style={{ fontFamily: 'var(--cx-font-sans)', fontSize: 120, fontWeight: 500, lineHeight: 1, letterSpacing: '-0.04em', marginTop: 8, color: 'var(--cx-paper)' }}>
                  45<span style={{ fontSize: 56, color: 'var(--cx-coral)' }}>%</span>
                </div>
                <div style={{ fontFamily: 'var(--cx-font-serif)', fontStyle: 'italic', fontSize: 22, marginTop: 14, color: 'var(--cx-paper)', lineHeight: 1.3, maxWidth: '22ch' }}>
                  of creator spend on Meta is unbranded — and not watched past the first three seconds.
                </div>
              </div>
