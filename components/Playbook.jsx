  ...
  return (
    <section className="sec sec--sand" id="playbook">
      <div className="wrap-wide">
        ...
        <h2 className="sec__title">Three moves, in order. Skip none.</h2>
        <p className="sec__lede">There is no single creative fix. The brands beating the market are the ones that stopped relying on memory and started running brand the way Engineering runs releases.</p>
